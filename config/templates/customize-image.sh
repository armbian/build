...
apt-get install -y build-essential cmake gfortran git wget curl graphicsmagick libgraphicsmagick1-dev libavcodec-dev libavformat-dev libboost-all-dev libgtk2.0-dev libjpeg-dev liblapack-dev libswscale-dev pkg-config python3-dev python3-numpy python3-pip zip

# Install dlib via pip
pip3 install dlib

# Clone face recognition and install its requirements
git clone https://github.com/jmcausing/video_face_detect.git /root/video_face_detect
pip3 install -r /root/video_face_detect/requirements.txt 

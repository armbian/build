...
function fetch_sources_tools__get_vendor_fip_and_gxlimg_source() {
	fetch_from_repo "https://github.com/retro98boy/cainiao-cniot-core-linux.git" "cainiao-cniot-core-linux" "commit:2c7f504b0df736a8d2d4c5d82eec8a4d958e6587"
	fetch_from_repo "https://github.com/repk/gxlimg.git" "gxlimg" "commit:0d0e5ba9cf396d1338067e8dc37a8bcd2e6874f1"
	# Fix non-zero return code of gi_fip_extract_ddrfw after success extraction
	sed -i "1561a    ret = 0;" "${SRC}/cache/sources/gxlimg/fip.c"
}

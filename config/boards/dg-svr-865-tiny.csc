# Qualcomm QCS8250 (SM8250) octa core 12/16GB RAM 256GB UFS GBE
declare -g BOARD_NAME="DG SVR 865 Tiny"
declare -g BOARD_VENDOR="dg741a"
...
declare -g -a ABL_DTB_LIST=("qcs8250-dg-svr-865-tiny")
...
function post_family_tweaks__qcom-dg-svr-865-tiny_extra_packages() {
	qcom-dg-svr-865-tiny_is_userspace_supported_alert || return 0
	...
	do_with_retries 3 chroot_sdcard_apt_get_install btop mtools zstd
...
function post_family_tweaks_bsp__qcom-dg-svr-865-tiny_bsp_firmware_in_initrd() {
	display_alert "Adding to bsp-cli" "${BOARD}: firmware in initrd" "info"
	declare file_added_to_bsp_destination # Will be filled in by add_file_from_stdin_to_bsp_destination
	# Using Elish's firmware for now
	add_file_from_stdin_to_bsp_destination "/etc/initramfs-tools/hooks/dg-svr-865-tiny-firmware" <<- 'FIRMWARE_HOOK'
		#!/bin/bash
		[[ "$1" == "prereqs" ]] && exit 0

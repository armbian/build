...
cp -R "${SRC}"/packages/blobs/desktop/debian-skel/skel.lxde/. "${destination}"/etc/skel
...
cat <<EOF > "${destination}"/usr/share/lxde-background-properties/armbian.xml
<?xml version="1.0"?>

...
setenv bootargs "root=LABEL=ROOTFS rootflags=data=writeback rw ${condev} vout=hdmi,enable hdmimode=${m} m_bpp=${m_bpp} cvbsmode=${cvbsmode} cvbsdrv=${cvbs_drv} fsck.repair=yes net.ifnames=0"

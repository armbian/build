...
setenv bootargs "root=${rootdev} rootwait rootfstype=${rootfstype} ${consoleargs} video=${disp_mode} consoleblank=0 loglevel=${verbosity} ubootpart=${partuuid} ubootsource=${devtype} usb-storage.quirks=${usbstoragequirks} ${extraargs} ${extraboardargs}"

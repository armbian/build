...
load ${devtype} 0:1 ${ramdisk_addr_r} /boot/uInitrd || ${devtype} mmc 0 ${ramdisk_addr_r} uInitrd
load ${devtype} 0:1 ${kernel_addr_r} /boot/zImage || ${devtype} mmc 0 ${kernel_addr_r} zImage

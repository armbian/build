...
setenv bootargs "root=${rootdev} rootfstype=${rootfstype} rw fsck.repair=yes rootwait ${bootargs} ${consoleargs} partition_type=generic loglevel=${verbosity} ${plymouthargs} ${extraargs} ${extraboardargs}"

...
if test -e mmc 0:1 boot/.next; 
	...
	else setenv bootargs "root=${rootdev} rootwait rootflags=data=writeback rw rootfstype=ext4 ${condev} no_console_suspend consoleblank=0 hdmimode=1080p60hz m_bpp=24 loglevel=5 net.ifnames=0"; fi

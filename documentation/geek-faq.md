...
- **COMPRESS_OUTPUTIMAGE** (**yes**|no): create zip archive with image file and GPG signature for redistribution. Takes effect only if `EXPERIMENTAL_DEBOOTSTRAP` is set to "yes"

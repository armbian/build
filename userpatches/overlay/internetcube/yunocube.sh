...
InstallInternetCubeServices(){
  ...
  apt-get install -o Dpkg::Options::='--force-confold' -y \
    ...
    sipcalc hostapd iptables iw dnsmasq firmware-linux-free \
    sipcalc dnsutils openvpn curl fake-hwclock \
    php-cli php-common php-intl php-json php-pear php-auth-sasl php-mail-mime php-patchwork-utf8 php-net-smtp php-net-socket php-zip php-gd php-mbstring php-curl

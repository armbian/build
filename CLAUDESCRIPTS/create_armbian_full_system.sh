#!/bin/bash
# Create full Armbian system with ROCKNIX kernel
# Uses ROCKNIX kernel + real Armbian rootfs for complete system
# Run with: sudo ./create_armbian_full_system.sh
...
echo "=========================================="
log_info "Full Armbian System with ROCKNIX Kernel"
log_info "Goal: Complete Armbian system with proven kernel"
echo "=========================================="
...
ARMBIAN_IMAGE="$OUTPUT_DIR/ARMBIAN-FULL-SYSTEM-${BUILD_DATE}.img"
